(function(){
    ...
    angular.module('fleio')
        .component('pluginsTicketsTicketsCreate', {
            templateUrl: 'staff/plugins/tickets/tickets_create/ticketscreate.html',
    ...
    function PluginsTicketsTicketsCreateController($state, gettextCatalog, PluginsTicketsTicketsApi,
                                                   FlNotificationService, FlResolveErrorHandler, FlClientApi, CONFIG,
                                                   PluginsTicketsTicketAttachmentsApi, PluginsTicketsDepartmentsApi,
                                                   $q, $scope, FlLocalStorage) {
        var $ctrl = this;
