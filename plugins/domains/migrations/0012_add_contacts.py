# Generated by Django 2.1.2 on 2018-10-24 14:26
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('domains', '0011_ns_ips_and_domain_epp'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('contact', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='custom_fields', to='domains.Contact')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='domain',
            name='contact',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='domains', to='domains.Contact'),
        ),
