(function () {
  ...
  angular.module('fleioStaff')
    .component('pluginsDomainsRegisterDomain', {
      templateUrl: 'staff/plugins/domains/register_domain/transferdomain.html',
  ...
  PluginsDomainsRegisterDomainController.$inject = ['gettext',
      'PluginsDomainsOrderDomainApi', 'FlNotificationService', '$state', '$mdDialog',
      'PluginsDomainsContactsActionsService'];
  function PluginsDomainsRegisterDomainController(gettext, PluginsDomainsOrderDomainApi, FlNotificationService,
