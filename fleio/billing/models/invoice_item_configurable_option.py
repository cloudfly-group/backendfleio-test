...
class InvoiceItemConfigurableOption(models.Model):
    """Invoice item configurable option attached to invoice items"""
    invoice_item = models.ForeignKey(InvoiceItem, related_name='configurable_options', on_delete=models.CASCADE)
    option = models.ForeignKey(ConfigurableOption, related_name='invoice_items_configurable_options',
