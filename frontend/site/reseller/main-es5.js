...
var routes = [
    {
        path: '',
        loadChildren: function () { return Promise.resolve(/*! import() */).then(__webpack_require__.bind(null, /*! ./reseller/reseller.module */ "./src/app/reseller/reseller.module.ts")).then(function (mod) { return mod.ResellerModule; }); },
...
var routes = [
    {
        path: '',
        loadChildren: function () { return Promise.all(/*! import() | dashboard-dashboard-module */[__webpack_require__.e("default~api-users-api-users-module~clients-clients-module~configurations-configurations-module~dashb~41d6bc1a"), __webpack_require__.e("common"), __webpack_require__.e("dashboard-dashboard-module")]).then(__webpack_require__.bind(null, /*! ./dashboard/dashboard.module */ "./src/app/reseller/dashboard/dashboard.module.ts")).then(function (mod) { return mod.DashboardModule; }); },
        canActivate: [_shared_auth_auth_guard__WEBPACK_IMPORTED_MODULE_4__["AuthGuard"]],
    },
    {
        path: 'clients-users',
        loadChildren: function () { return __webpack_require__.e(/*! import() | clients-users-clients-users-module */ "clients-users-clients-users-module").then(__webpack_require__.bind(null, /*! ./clients-users/clients-users.module */ "./src/app/reseller/clients-users/clients-users.module.ts")).then(function (mod) { return mod.ClientsUsersModule; }); },
        canActivate: [_shared_auth_auth_guard__WEBPACK_IMPORTED_MODULE_4__["AuthGuard"]],
    },
    {
        path: 'cloud',
        loadChildren: function () { return __webpack_require__.e(/*! import() | cloud-cloud-module */ "cloud-cloud-module").then(__webpack_require__.bind(null, /*! ./cloud/cloud.module */ "./src/app/reseller/cloud/cloud.module.ts")).then(function (mod) { return mod.CloudModule; }); },
        canActivate: [_shared_auth_auth_guard__WEBPACK_IMPORTED_MODULE_4__["AuthGuard"]],
    },
    {
        path: 'billing',
        loadChildren: function () { return __webpack_require__.e(/*! import() | billing-billing-module */ "billing-billing-module").then(__webpack_require__.bind(null, /*! ./billing/billing.module */ "./src/app/reseller/billing/billing.module.ts")).then(function (mod) { return mod.BillingModule; }); },
        canActivate: [_shared_auth_auth_guard__WEBPACK_IMPORTED_MODULE_4__["AuthGuard"]],
    },
    {
        path: 'settings',
        loadChildren: function () { return __webpack_require__.e(/*! import() | settings-settings-module */ "settings-settings-module").then(__webpack_require__.bind(null, /*! ./settings/settings.module */ "./src/app/reseller/settings/settings.module.ts")).then(function (mod) { return mod.SettingsModule; }); },
        canActivate: [_shared_auth_auth_guard__WEBPACK_IMPORTED_MODULE_4__["AuthGuard"]],
    },
    {
        path: 'user-profile',
        loadChildren: function () { return __webpack_require__.e(/*! import() | profile-profile-module */ "profile-profile-module").then(__webpack_require__.bind(null, /*! ./profile/profile.module */ "./src/app/reseller/profile/profile.module.ts")).then(function (mod) { return mod.ProfileModule; }); },
        canActivate: [_shared_auth_auth_guard__WEBPACK_IMPORTED_MODULE_4__["AuthGuard"]],
    },
    {
        path: 'login',
...
var ResellerRoutingModule = /** @class */ (function () {
    function ResellerRoutingModule() {
    }
...
var ResellerModule = /** @class */ (function () {
    function ResellerModule() {
    }
...
var ResellerComponent = /** @class */ (function () {
    function ResellerComponent() {
    }
    ResellerComponent.prototype.ngOnInit = function () {
    };
...
var AuthInterceptor = /** @class */ (function () {
    function AuthInterceptor(notificationService) {
        this.notificationService = notificationService;
    }
    AuthInterceptor.prototype.intercept = function (req, next) {
        var params = new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpParams"]({ encoder: new CustomEncoder(), fromString: req.params.toString() });
...
var AuthGuard = /** @class */ (function () {
    ...
    AuthGuard.prototype.canActivate = function (route, state) {
        var _this = this;
        return this.authService.checkIfLoggedIn().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function (isAuthenticated) {
            var isLoginPage = route.routeConfig.path === 'login';
            if (isAuthenticated && isLoginPage) {
                // we are on login page, but we are already authenticated, go to home page
                return _this.router.parseUrl(_this.config.getPanelHomeUrl());
            }
            if (route.data.config && route.data.config.feature) {
                if (_this.authService.userData.features[route.data.config.feature] === false) {
                    return _this.router.parseUrl(_this.config.getPanelUrl('404'));
                }
            }
            if (!isAuthenticated && !isLoginPage) {
                // we are not authenticated and we are not on login page, redirect to login page
                return _this.router.parseUrl(_this.config.getPanelUrl('login'));
            }
            return true;
        }));
    };
...
var AuthService = /** @class */ (function () {
    ...
    AuthService.prototype.feature = function (featureName) {
    ...
    AuthService.prototype.checkIfLoggedIn = function () {
        var _this = this;
        return this.httpClient.get(this.currentUserEndpoint).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["map"])(function (currentUserData) {
            _this.userData = currentUserData;
            _this.userDataBS.next(_this.userData);
            var loggedIn = !!_this.userData.user;
            _this.isLoggedInBS.next(loggedIn);
            return loggedIn;
        }));
    };
    AuthService.prototype.login = function (username, password, rememberMe) {
        ...
        return this.httpClient.post(this.loginEndpoint, {
            ...
            sfa_params: null
        }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["map"])(function (currentUserData) {
            _this.userData = currentUserData;
    ...
    AuthService.prototype.logout = function () {
        return this.httpClient.post(this.logoutEndpoint, {}).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["map"])(function (response) {
            return response;
        }));
    };
    AuthService.prototype.isImpersonating = function () {
        return this.userData && this.userData.impersonated;
    };
    AuthService.prototype.stopImpersonating = function () {
        var staffBackendUrl = localStorage.getItem('fleio.flStaffBackend');
        var staffFrontendUrl = localStorage.getItem('fleio.flStaffUrl');
        this.httpClient.post(staffBackendUrl + "/users/stop_impersonation", {}).subscribe(function () {
...
var LoginComponent = /** @class */ (function () {
    function LoginComponent(formBuilder, router, auth, config) {
    ...
    LoginComponent.prototype.login = function () {
        var _this = this;
        this.auth.login(this.loginForm.controls.username.value, this.loginForm.controls.password.value, this.loginForm.controls.rememberMe.value).subscribe(function (authResult) {
            if (authResult.success) {
                // TODO: see about this warning
                // TODO: go back instead of home if possible
                _this.router.navigateByUrl(_this.config.getPrevUrl()).then(function () { });
            }
            else {
                _this.formErrors.showError(authResult.errorMessage);
            }
        });
    };
...
var ConfigModule = /** @class */ (function () {
    function ConfigModule(router, config) {
        this.router = router;
        this.config = config;
...
var configFilesPath = 'assets/config/';
var appConfigFile = configFilesPath + 'app.config.json';
var ConfigService = /** @class */ (function () {
    function ConfigService(httpClient, title, locale) {
        this.httpClient = httpClient;
        this.title = title;
        this.locale = locale;
    ...
    ConfigService.prototype._initShortcuts = function () {
    ...
    ConfigService.prototype.setActiveConfiguration = function (configurationName) {
        // update configuration
        this.current = this.panels[configurationName];
        // TODO: load this dynamically
        this.title.setTitle(configurationName);
    };
    ConfigService.prototype.setActiveUrl = function (url) {
        // update urls
        this.previousUrl = this.currentUrl;
        this.currentUrl = url;
    };
    ConfigService.prototype.subscribeToRouterEvents = function (router) {
        var _this = this;
        if (!this.isSubscribedToRouterEvents) {
            router.events.subscribe(function (event) {
                if (event instanceof _angular_router__WEBPACK_IMPORTED_MODULE_3__["RouteConfigLoadStart"]) {
                    var routeConfigLoadStart = event;
                    if (routeConfigLoadStart.route.data && routeConfigLoadStart.route.data.configurationName) {
                        _this.setActiveConfiguration(routeConfigLoadStart.route.data.configurationName);
                    }
                }
                if (event instanceof _angular_router__WEBPACK_IMPORTED_MODULE_3__["NavigationEnd"]) {
                    _this.setActiveUrl(event.url);
                }
            });
            this.isSubscribedToRouterEvents = true;
        }
    };
    ConfigService.prototype.getPanelApiUrl = function (endpoint) {
        return this.current.urls.backendApiUrl + endpoint;
    };
    ConfigService.prototype.getPanelUrl = function (fragment) {
        var url = this.current.urls.baseUrl + fragment;
        return url;
    };
    ConfigService.prototype.getPanelHomeUrl = function () {
        // TODO: rename homeUrl to home name and also rename this function
        return this.current.urls.homeUrl;
    };
    ConfigService.prototype.getImagePath = function (imageName) {
        return this.current.settings.imagesPath + imageName;
    };
    ConfigService.prototype.getPrevUrl = function (defaultFragment) {
        if (defaultFragment === void 0) { defaultFragment = null; }
    ...
    ConfigService.prototype.getCurrentUrl = function () {
        return this.currentUrl;
    };
    ConfigService.prototype.loadPanelConfiguration = function (panelName, fileName) {
        var _this = this;
        return new Promise(function (resolve, reject) {
            var panelConfigFile = configFilesPath + fileName;
            _this.httpClient.get(panelConfigFile).toPromise().then(function (response) {
                _this.panels[panelName] = response;
                resolve();
            }).catch(function () {
    ...
    ConfigService.prototype.load = function () {
        var _this = this;
        return new Promise(function (resolve, reject) {
            _this.httpClient.get(appConfigFile).toPromise().then(function (response) {
                _this.app = response;
                var promises = [];
                Object.keys(_this.app.panels).map(function (panelName) {
                    var panel = _this.app.panels[panelName];
                    promises.push(_this.loadPanelConfiguration(panelName, panel.configFile));
                });
...
var ErrorInterceptor = /** @class */ (function () {
    function ErrorInterceptor(notificationService, configService, router, httpClient) {
        this.notificationService = notificationService;
        this.configService = configService;
        this.router = router;
        this.httpClient = httpClient;
    }
    ErrorInterceptor.prototype.initAuthService = function () {
        if (!this.authService) {
        ...
        return next.handle(req).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(function (error) {
            if (error instanceof _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpErrorResponse"]) {
                ...
                switch (httpError.status) {
                    case 401:
                        // authorization error
                        if (_this.configService.getCurrentUrl() === _this.configService.getPanelUrl('login')) {
                            // we are at login page, pass error
                            throw error;
                        }
                        console.warn('Unauthorized, redirecting to login');
                        _this.notificationService.showMessage(error.error.detail);
                        _this.initAuthService();
                        _this.authService.logout().subscribe(function () {
                            _this.router.navigateByUrl(_this.configService.getPanelUrl('login')).then(function () { });
                        });
                    ...
                    case 400:
                        ...
                        break;
                    default:
                        _this.notificationService.showMessage("HTTP Error " + httpError.status + ": " + httpError.statusText);
                }
            }
            throw error;
        }));
...
var FormErrorsComponent = /** @class */ (function () {
    ...
    FormErrorsComponent.prototype.hide = function () {
        this.visible = false;
    };
    FormErrorsComponent.prototype.setBackendErrors = function (backendErrors) {
        var _this = this;
        ...
        var nonFieldErrors = [];
        Object.keys(backendErrors).map(function (fieldName) {
            var control = _this.formGroup.get(fieldName);
    ...
    FormErrorsComponent.prototype.showMultipleErrors = function (errorMessages) {
        this.errorMessages = errorMessages;
        this.visible = true;
    };
    FormErrorsComponent.prototype.showError = function (errorMessage) {
...
var PhoneInputComponent = /** @class */ (function () {
    ...
    PhoneInputComponent.prototype.changePhoneCountry = function () {
    ...
    PhoneInputComponent.prototype.updateFlagOnPhoneChange = function (newPhone) {
        if (newPhone) {
            if (this.error) {
                this.error = null;
            }
...
var AppLocalStorageService = /** @class */ (function () {
    function AppLocalStorageService(authService, activatedRoute) {
        this.authService = authService;
        this.activatedRoute = activatedRoute;
    }
    AppLocalStorageService.prototype.setItem = function (item, value) {
    ...
    AppLocalStorageService.prototype.getItem = function (item) {
        if (this.authService.userData.user && this.authService.userData.user.username) {
    ...
    AppLocalStorageService.prototype.setOrderingItem = function (orderingItem, routePath) {
        if (routePath === void 0) { routePath = null; }
        var routeHelper = new _route_helper__WEBPACK_IMPORTED_MODULE_4__["RouteHelper"](this.activatedRoute);
        this.setItem('-ordering-' + (routePath || routeHelper.getRoutePath()), JSON.stringify(orderingItem));
    };
    AppLocalStorageService.prototype.getOrderingItem = function (routePath) {
        if (routePath === void 0) { routePath = null; }
        var routeHelper = new _route_helper__WEBPACK_IMPORTED_MODULE_4__["RouteHelper"](this.activatedRoute);
        var savedValue = this.getItem('-ordering-' + (routePath || routeHelper.getRoutePath()));
        if (savedValue) {
            return JSON.parse(savedValue);
        }
        return null;
    };
    AppLocalStorageService.prototype.setCardsDisplay = function (cardsDisplay) {
        var routeHelper = new _route_helper__WEBPACK_IMPORTED_MODULE_4__["RouteHelper"](this.activatedRoute);
        this.setItem('-cardsdisplay-' + routeHelper.getRoutePath(), JSON.stringify(cardsDisplay));
    };
    AppLocalStorageService.prototype.getCardsDisplay = function () {
        var routeHelper = new _route_helper__WEBPACK_IMPORTED_MODULE_4__["RouteHelper"](this.activatedRoute);
        var savedValue = this.getItem('-cardsdisplay-' + routeHelper.getRoutePath());
        if (savedValue) {
            return JSON.parse(savedValue);
        }
        return null;
    };
    AppLocalStorageService.ctorParameters = function () { return [
...
var OrderingHelper = /** @class */ (function () {
    function OrderingHelper() {
    }
    OrderingHelper.getOrderingValue = function (orderingOption) {
    ...
    OrderingHelper.getOrderingOptionFieldAndDirection = function (orderingValue) {
    ...
    OrderingHelper.isDescending = function (orderingOption) {
        switch (orderingOption.direction) {
            case _interfaces_route_config_ordering_directions__WEBPACK_IMPORTED_MODULE_0__["OrderingDirection"].Ascending:
                return false;
            case _interfaces_route_config_ordering_directions__WEBPACK_IMPORTED_MODULE_0__["OrderingDirection"].Descending:
    ...
    OrderingHelper.fromSort = function (sort) {
        return {
            field: sort.active,
            display: null,
    ...
    OrderingHelper.toSort = function (orderingConfig) {
        return {
...
var NotificationService = /** @class */ (function () {
    function NotificationService(matSnackBar, matDialog) {
    ...
    NotificationService.prototype.confirmDialog = function (yesNoData) {
...
var OrderingService = /** @class */ (function () {
    function OrderingService(router, activatedRoute, appLocalStorage) {
        var _this = this;
        this.router = router;
        this.activatedRoute = activatedRoute;
        ...
        router.events.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_7__["filter"])(function (event) {
            return event instanceof _angular_router__WEBPACK_IMPORTED_MODULE_2__["NavigationEnd"];
        })).subscribe(function () {
            var snapshot = new _route_helper__WEBPACK_IMPORTED_MODULE_6__["RouteHelper"](activatedRoute).getFinalRoute().snapshot;
            if (snapshot && snapshot.queryParams) {
                var ordering = _this.getOrderingConfig(snapshot.data, snapshot.queryParams);
                if (ordering) {
                    _this.orderingBS.next(ordering);
                }
            }
        });
    }
    OrderingService.prototype.getOrderingConfig = function (data, queryParams) {
        var e_1, _a;
        if (!data.config) {
            return null;
        }
        var routeConfig = data.config;
        if (!routeConfig.ordering) {
            return null;
        }
        var ordering = Object.assign({}, routeConfig.ordering);
        if (queryParams.ordering) {
            var queryOrdering = _helpers_ordering_helper__WEBPACK_IMPORTED_MODULE_4__["OrderingHelper"].getOrderingOptionFieldAndDirection(queryParams.ordering);
            try {
                for (var _b = tslib__WEBPACK_IMPORTED_MODULE_0__["__values"](ordering.options), _c = _b.next(); !_c.done; _c = _b.next()) {
                    var orderOption = _c.value;
            ...
            var savedOrdering = this.appLocalStorage.getOrderingItem();
            if (savedOrdering) {
    ...
    OrderingService.prototype.orderBy = function (ordering) {
        if (ordering) {
            var orderingValue = _helpers_ordering_helper__WEBPACK_IMPORTED_MODULE_4__["OrderingHelper"].getOrderingValue(ordering);
            var queryParams = { ordering: undefined };
            Object.assign(queryParams, this.activatedRoute.snapshot.queryParams);
            var urlOrderingValue = queryParams.ordering;
    ...
    OrderingService.prototype.getQueryParams = function (routeUrl) {
        var ordering = this.appLocalStorage.getOrderingItem(routeUrl);
        if (ordering) {
            return {
    ...
    OrderingService.ctorParameters = function () { return [
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] },
...
var RouteHelper = /** @class */ (function () {
    ...
    RouteHelper.prototype.getFinalRoute = function () {
    ...
    RouteHelper.prototype.getRoutePath = function () {
        var e_1, _a;
        var route = this.getFinalRoute();
        var urlSegments = [];
        try {
            for (var _b = tslib__WEBPACK_IMPORTED_MODULE_0__["__values"](route.pathFromRoot), _c = _b.next(); !_c.done; _c = _b.next()) {
                var routeSegment = _c.value;
    ...
    RouteHelper.prototype.getRouteConfig = function () {
        var route = this.getFinalRoute();
    ...
    RouteHelper.prototype.getSearchConfig = function () {
    ...
    RouteHelper.prototype.getUrlChanges = function (nextUrl) {
        var currentPath = this.getRoutePath();
        var parts = nextUrl.split('?');
        var nextPath = parts[0];
        var nextQuery = parts.length > 1 ? parts[1] : null;
        var changes = {
    ...
    RouteHelper.ctorParameters = function () { return [
...
var SearchService = /** @class */ (function () {
    function SearchService(router, route) {
        this.router = router;
        this.route = route;
    }
    SearchService.prototype.search = function (searchText) {
        var queryParams = { search: undefined };
        Object.assign(queryParams, this.route.snapshot.queryParams);
        var urlSearchText = queryParams.search;
...
var UiApiModule = /** @class */ (function () {
    function UiApiModule() {
    }
...
var YesNoDialogComponent = /** @class */ (function () {
    ...
    YesNoDialogComponent.prototype.close = function () {
        this.dialogRef.close('no');
    };
    YesNoDialogComponent.ctorParameters = function () { return [
...
var FlBackdropComponent = /** @class */ (function () {
    function FlBackdropComponent() {
        this.spinnerDiameter = 70;
        this.verticalAlignMiddle = false;
    }
    FlBackdropComponent.prototype.ngOnInit = function () {
    };
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])()
...
var MenuItemContainerComponent = /** @class */ (function () {
    function MenuItemContainerComponent(menuService, activatedRoute) {
        this.menuService = menuService;
        this.activatedRoute = activatedRoute;
        this.expanded = false;
    }
    MenuItemContainerComponent.prototype.toggle = function () {
    ...
    MenuItemContainerComponent.prototype.expand = function () {
        this.menuService.expandedMenuItemContainer = this.menuItemContainer.display;
    };
    MenuItemContainerComponent.prototype.getExpanded = function () {
        return this.menuService.expandedMenuItemContainer === this.menuItemContainer.display;
    };
    MenuItemContainerComponent.prototype.ngOnInit = function () {
        var e_1, _a;
        var routePath = '/' + new _ui_api_route_helper__WEBPACK_IMPORTED_MODULE_5__["RouteHelper"](this.activatedRoute).getRoutePath();
        try {
            for (var _b = tslib__WEBPACK_IMPORTED_MODULE_0__["__values"](this.menuItemContainer.items), _c = _b.next(); !_c.done; _c = _b.next()) {
    ...
    MenuItemContainerComponent.ctorParameters = function () { return [
    ...
    return MenuItemContainerComponent;
}());
...
var SideNavMenuComponent = /** @class */ (function () {
    function SideNavMenuComponent(config, authService, orderingService) {
        this.config = config;
        this.authService = authService;
        this.orderingService = orderingService;
    }
    SideNavMenuComponent.prototype.canAddMenuItem = function (feature) {
        return !!(this.authService.userData && this.authService.userData.features[feature]);
    };
    SideNavMenuComponent.prototype.canShowMenuItemContainer = function (menuItemContainer) {
        var e_1, _a;
        var itemsNotShownCount = 0;
        try {
            for (var _b = tslib__WEBPACK_IMPORTED_MODULE_0__["__values"](menuItemContainer.items), _c = _b.next(); !_c.done; _c = _b.next()) {
                var item = _c.value;
    ...
    SideNavMenuComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.orderingService.ordering$.subscribe(function () {
            _this.refreshMenu();
        });
    };
    SideNavMenuComponent.prototype.refreshMenu = function () {
    ...
    SideNavMenuComponent.ctorParameters = function () { return [
        { type: _config_config_service__WEBPACK_IMPORTED_MODULE_2__["ConfigService"] },
...
var PanelLayoutComponent = /** @class */ (function () {
    function PanelLayoutComponent(auth, router, activatedRoute) {
        this.auth = auth;
        this.router = router;
        this.activatedRoute = activatedRoute;
    ...
    PanelLayoutComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.innerWidth = window.innerWidth;
        this.isLoggedInSubscription = this.auth.isLoggedIn.subscribe(function (isLoggedIn) {
            _this.innerWidth = window.innerWidth;
            if (_this.innerWidth > 1280) {
                // show sidebar on web page enter only for large screens
                _this.showSidebar = isLoggedIn;
            }
            else {
                _this.showSidebar = false;
            }
            _this.showTopBar = isLoggedIn;
        });
        this.routerEventsSubscription = this.router.events.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["delay"])(0)).subscribe(function (event) {
            switch (true) {
                case event instanceof _angular_router__WEBPACK_IMPORTED_MODULE_4__["NavigationStart"]: {
                    var urlChanges = _this.routeHelper.getUrlChanges(event.url);
                    _this.loading = urlChanges.path || urlChanges.query;
                    break;
                }
    ...
    PanelLayoutComponent.prototype.ngOnDestroy = function () {
        this.isLoggedInSubscription.unsubscribe();
        this.routerEventsSubscription.unsubscribe();
    };
    PanelLayoutComponent.ctorParameters = function () { return [
        { type: _auth_auth_service__WEBPACK_IMPORTED_MODULE_2__["AuthService"] },
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_4__["Router"] },
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_4__["ActivatedRoute"] }
    ]; };
...
var BreadcrumbsComponent = /** @class */ (function () {
    function BreadcrumbsComponent(router, activatedRoute, config, ordering) {
        this.router = router;
        this.activatedRoute = activatedRoute;
        this.config = config;
    ...
    BreadcrumbsComponent.prototype.changeBreads = function () {
        var e_1, _a;
        var homeUrl = this.config.getPanelUrl(this.config.getPanelHomeUrl());
        var routePath;
        ...
        var routeParent = this.breadCrumbsDisplay.splice(0, 1);
        // determine and add the home bread crumb
        var homeBreadCrumbDisplay;
        if (homeUrl === '/') {
        ...
        if (this.breadCrumbsDisplay[2]) {
            var finalRoute = this.routeHelper.getFinalRoute();
        ...
        this.breadCrumbs = [];
        try {
            for (var _b = tslib__WEBPACK_IMPORTED_MODULE_0__["__values"](this.breadCrumbsDisplay), _c = _b.next(); !_c.done; _c = _b.next()) {
                var breadCrumbDisplay = _c.value;
                ...
                if (this.breadCrumbsDisplay.length > 1) {
                    ...
                    if (i === 0) {
                        ...
                        var urlFragment = routeParent + '/' + breadCrumbDisplay;
...
var HelloUserButtonComponent = /** @class */ (function () {
    function HelloUserButtonComponent(authService, router, config) {
        this.authService = authService;
        this.router = router;
        this.config = config;
    }
    HelloUserButtonComponent.prototype.logout = function () {
        var _this = this;
        this.authService.logout().subscribe(function () {
            _this.router.navigateByUrl(_this.config.getPanelUrl('login')).then(function () { });
        });
    };
    HelloUserButtonComponent.prototype.ngOnInit = function () {
    };
    HelloUserButtonComponent.ctorParameters = function () { return [
        { type: _auth_auth_service__WEBPACK_IMPORTED_MODULE_2__["AuthService"] },
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"] },
        { type: _config_config_service__WEBPACK_IMPORTED_MODULE_4__["ConfigService"] }
    ]; };
    ...
    return HelloUserButtonComponent;
}());
...
var SearchBoxComponent = /** @class */ (function () {
    function SearchBoxComponent(route, router, searchService) {
        this.route = route;
        this.router = router;
    ...
    SearchBoxComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.setSearchText();
        this.searchText.valueChanges.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(function () { return _this.searchText.value; }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["debounceTime"])(1000)).subscribe(function (searchText) {
            _this.searchService.search(searchText);
        });
    };
    SearchBoxComponent.prototype.setSearchText = function () {
        var routeSnapshot = new _ui_api_route_helper__WEBPACK_IMPORTED_MODULE_6__["RouteHelper"](this.route).getFinalRoute().snapshot;
    ...
    SearchBoxComponent.prototype.clearSearch = function () {
        this.searchText.setValue(undefined, { emitEvent: false });
...
var StopImpersonatingButtonComponent = /** @class */ (function () {
    function StopImpersonatingButtonComponent(auth) {
        this.auth = auth;
    }
    StopImpersonatingButtonComponent.prototype.ngOnInit = function () {
    };
    StopImpersonatingButtonComponent.prototype.closeImpersonation = function () {
        this.auth.stopImpersonating();
    };
    StopImpersonatingButtonComponent.ctorParameters = function () { return [
        { type: _auth_auth_service__WEBPACK_IMPORTED_MODULE_2__["AuthService"] }
    ]; };
    ...
    return StopImpersonatingButtonComponent;
}());
...
var TopBarComponent = /** @class */ (function () {
    function TopBarComponent(router, activatedRoute, auth) {
        this.router = router;
        this.activatedRoute = activatedRoute;
        this.auth = auth;
    ...
    TopBarComponent.prototype.ngOnInit = function () {
        ...
        this.routerEventSubscription = this.router.events.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["filter"])(function (event) {
            ...
            return _this.routeHelper.getSearchConfig();
        }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["startWith"])(this.routeHelper.getSearchConfig())).subscribe(function (searchConfig) {
            _this.searchConfig = searchConfig;
            if (_this.searchConfig.show && _this.searchBox && _this.routeHelper.getUrlChanges(_this.router.url).query) {
                _this.searchBox.setSearchText();
            }
        });
    };
