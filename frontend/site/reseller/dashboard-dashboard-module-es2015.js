...
let ClientsPanelComponent = class ClientsPanelComponent {
...
ClientsPanelComponent.ctorParameters = () => [
...
let InvoicesPanelComponent = class InvoicesPanelComponent {
    ...
    ngOnInit() {
        this.invoicesApi.getAction('summary').subscribe((response) => {
            this.tableData.push({
                description: 'Paid',
...
InvoicesPanelComponent.ctorParameters = () => [
