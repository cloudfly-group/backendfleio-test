...
var ServiceDetailsComponent = /** @class */ (function (_super) {
    tslib__WEBPACK_IMPORTED_MODULE_0__["__extends"](ServiceDetailsComponent, _super);
    function ServiceDetailsComponent(route, serviceListUIService) {
        return _super.call(this, route, serviceListUIService, 'details', 'service') || this;
    }
...
var ServiceEditComponent = /** @class */ (function (_super) {
    tslib__WEBPACK_IMPORTED_MODULE_0__["__extends"](ServiceEditComponent, _super);
    function ServiceEditComponent(route, serviceListUIService) {
        return _super.call(this, route, serviceListUIService, 'edit', 'service') || this;
    }
    ServiceEditComponent.ctorParameters = function () { return [
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_3__["ActivatedRoute"] },
        { type: _service_list_ui_service__WEBPACK_IMPORTED_MODULE_4__["ServiceListUIService"] }
    ]; };
...
var ServiceListUIService = /** @class */ (function () {
    function ServiceListUIService(router, config, servicesApiService) {
        this.router = router;
        this.config = config;
    ...
    ServiceListUIService.prototype.getObjectUIService = function (object, permissions, state) {
    ...
    ServiceListUIService.prototype.getTableData = function (objectList) {
        var e_1, _a;
        var tableData = {
            header: {
                columns: [
        ...
        try {
            for (var _b = tslib__WEBPACK_IMPORTED_MODULE_0__["__values"](objectList.objects), _c = _b.next(); !_c.done; _c = _b.next()) {
                ...
                var rowUIService = this.getObjectUIService(service, objectList.permissions, 'table-view');
                var row = {
                    cells: {
    ...
    ServiceListUIService.prototype.getActions = function (objectList) {
        return null;
    };
    ServiceListUIService.ctorParameters = function () { return [
...
var ServiceListComponent = /** @class */ (function (_super) {
    tslib__WEBPACK_IMPORTED_MODULE_0__["__extends"](ServiceListComponent, _super);
    function ServiceListComponent(route, serviceListUIService, refreshService) {
        var _this = _super.call(this, route, serviceListUIService, refreshService, 'services') || this;
        _this.route = route;
        _this.serviceListUIService = serviceListUIService;
...
/* harmony import */ var _tabs_service_details_overview_service_details_overview_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./tabs/service-details-overview/service-details-overview.component */ "./src/app/reseller/billing/services/tabs/service-details-overview/service-details-overview.component.ts");
/* harmony import */ var _tabs_service_edit_form_service_edit_form_component__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./tabs/service-edit-form/service-edit-form.component */ "./src/app/reseller/billing/services/tabs/service-edit-form/service-edit-form.component.ts");
...
var ServiceUIService = /** @class */ (function (_super) {
    tslib__WEBPACK_IMPORTED_MODULE_0__["__extends"](ServiceUIService, _super);
    function ServiceUIService(service, permissions, state, router, config, servicesApiService) {
        var _this = _super.call(this, service, permissions, state) || this;
        _this.router = router;
        _this.config = config;
        _this.servicesApiService = servicesApiService;
        return _this;
    }
    ServiceUIService.prototype.getIcon = function () {
        return null;
    };
    ServiceUIService.prototype.getStatus = function () {
    ...
    ServiceUIService.prototype.getTitle = function () {
        switch (this.state) {
            case 'edit':
                return {
    ...
    ServiceUIService.prototype.getActions = function () {
        var actions = [];
    ...
    ServiceUIService.prototype.getDetailsLink = function () {
        return this.config.getPanelUrl("billing/services/" + this.object.id);
    };
    ServiceUIService.prototype.getCardFields = function () {
        var datePipe = new _angular_common__WEBPACK_IMPORTED_MODULE_11__["DatePipe"](this.config.locale);
        var fields = [
            {
                name: 'Client',
    ...
    ServiceUIService.prototype.getTabs = function () {
        switch (this.state) {
            case 'details':
                return [
                    {
                        tabName: 'Overview',
                        component: _tabs_service_details_overview_service_details_overview_component__WEBPACK_IMPORTED_MODULE_8__["ServiceDetailsOverviewComponent"],
                    },
                ];
            case 'edit':
            case 'create':
                return [
                    {
                        tabName: 'Edit',
                        component: _tabs_service_edit_form_service_edit_form_component__WEBPACK_IMPORTED_MODULE_9__["ServiceEditFormComponent"],
                    },
                ];
        }
    };
    ServiceUIService.prototype.getCardTags = function () {
        return [];
    };
    ServiceUIService.prototype.getDetailsActions = function () {
        var actions = [];
        switch (this.state) {
            case 'create':
                actions.push(new _shared_ui_objects_view_actions_router_link_action__WEBPACK_IMPORTED_MODULE_3__["RouterLinkAction"]({
    ...
    ServiceUIService.ctorParameters = function () { return [
        { type: undefined },
        { type: undefined },
        { type: String },
...
var ServiceDetailsOverviewComponent = /** @class */ (function (_super) {
    tslib__WEBPACK_IMPORTED_MODULE_0__["__extends"](ServiceDetailsOverviewComponent, _super);
    function ServiceDetailsOverviewComponent(config) {
        var _this = _super.call(this) || this;
        _this.config = config;
        return _this;
    }
    ServiceDetailsOverviewComponent.prototype.ngOnInit = function () {
    };
    ServiceDetailsOverviewComponent.ctorParameters = function () { return [
        { type: _shared_config_config_service__WEBPACK_IMPORTED_MODULE_3__["ConfigService"] }
    ]; };
    ...
    return ServiceDetailsOverviewComponent;
...
var ServiceEditFormComponent = /** @class */ (function (_super) {
    tslib__WEBPACK_IMPORTED_MODULE_0__["__extends"](ServiceEditFormComponent, _super);
    function ServiceEditFormComponent(formBuilder, clientsApi, activatedRoute, router, config, servicesApi) {
        var _this = _super.call(this) || this;
        ...
        _this.serviceForm = _this.formBuilder.group({
    ...
    ServiceEditFormComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.objectController.actionCallback = function () { return _this.saveService(); };
        this.serviceForm.patchValue(this.object);
    };
    ServiceEditFormComponent.prototype.saveService = function () {
        var _this = this;
        var value = this.serviceForm.value;
        value.status = this.object.status;
        value.product = this.object.product.id;
        value.cycle = this.object.cycle.id;
        this.createOrUpdate(this.servicesApi, value).subscribe(function () {
            _this.router.navigateByUrl(_this.config.getPrevUrl('billing/services')).catch(function () {
            });
        });
        return Object(rxjs__WEBPACK_IMPORTED_MODULE_8__["of"])(null);
    };
    ServiceEditFormComponent.ctorParameters = function () { return [
    ...
    return ServiceEditFormComponent;
...
var ServiceListResolver = /** @class */ (function () {
    function ServiceListResolver(servicesApiService) {
        this.servicesApiService = servicesApiService;
    }
    ServiceListResolver.prototype.resolve = function (route, state) {
        return this.servicesApiService.list(route.queryParams).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["catchError"])(function () { return Object(rxjs__WEBPACK_IMPORTED_MODULE_2__["of"])(null); }));
    };
    ServiceListResolver.ctorParameters = function () { return [
...
var ServiceResolver = /** @class */ (function () {
    function ServiceResolver(servicesApiService) {
        this.servicesApiService = servicesApiService;
    }
    ServiceResolver.prototype.resolve = function (route, state) {
        return this.servicesApiService.get(route.params.id).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["catchError"])(function () { return Object(rxjs__WEBPACK_IMPORTED_MODULE_2__["of"])(null); }));
    };
    ServiceResolver.ctorParameters = function () { return [
        { type: _service_api_service__WEBPACK_IMPORTED_MODULE_4__["ServicesApiService"] }
    ]; };
