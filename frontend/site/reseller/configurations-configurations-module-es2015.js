...
let ConfigurationCreateComponent = class ConfigurationCreateComponent extends _shared_ui_objects_view_details_base__WEBPACK_IMPORTED_MODULE_2__["DetailsBase"] {
    constructor(activatedRoute, configurationListUIService) {
        super(activatedRoute, configurationListUIService, 'create', null);
        this.activatedRoute = activatedRoute;
        this.configurationListUIService = configurationListUIService;
    }
    ngOnInit() {
        super.ngOnInit();
    }
};
ConfigurationCreateComponent.ctorParameters = () => [
...
let ConfigurationDetailsComponent = class ConfigurationDetailsComponent extends _shared_ui_objects_view_details_base__WEBPACK_IMPORTED_MODULE_2__["DetailsBase"] {
    constructor(route, configurationListUIService) {
        super(route, configurationListUIService, 'details', 'configuration', ['billingConfiguration']);
    }
};
ConfigurationDetailsComponent.ctorParameters = () => [
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_3__["ActivatedRoute"] },
    { type: _configuration_list_ui_service__WEBPACK_IMPORTED_MODULE_4__["ConfigurationListUIService"] }
];
...
let ConfigurationEditComponent = class ConfigurationEditComponent extends _shared_ui_objects_view_details_base__WEBPACK_IMPORTED_MODULE_2__["DetailsBase"] {
    constructor(route, configurationListUIService) {
        super(route, configurationListUIService, 'edit', 'configuration');
    }
};
ConfigurationEditComponent.ctorParameters = () => [
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_3__["ActivatedRoute"] },
    { type: _configuration_list_ui_service__WEBPACK_IMPORTED_MODULE_4__["ConfigurationListUIService"] }
];
...
let ConfigurationListUIService = class ConfigurationListUIService {
    constructor(router, config, configurationsApiService) {
        this.router = router;
        this.config = config;
...
ConfigurationListUIService.ctorParameters = () => [
...
let ConfigurationListComponent = class ConfigurationListComponent extends _shared_ui_objects_view_list_base__WEBPACK_IMPORTED_MODULE_2__["ListBase"] {
    constructor(route, configurationListUIService, refreshService) {
...
/* harmony import */ var _tabs_configuration_edit_form_configuration_edit_form_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./tabs/configuration-edit-form/configuration-edit-form.component */ "./src/app/reseller/settings/configurations/tabs/configuration-edit-form/configuration-edit-form.component.ts");
/* harmony import */ var _tabs_configuration_details_billing_form_configuration_details_billing_form_component__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./tabs/configuration-details-billing-form/configuration-details-billing-form.component */ "./src/app/reseller/settings/configurations/tabs/configuration-details-billing-form/configuration-details-billing-form.component.ts");
...
class ConfigurationUiService extends _shared_ui_objects_view_object_ui_service_base__WEBPACK_IMPORTED_MODULE_0__["ObjectUIServiceBase"] {
    constructor(configuration, permissions, state, router, config, configurationsApiService) {
    ...
    getActions() {
        ...
        const deleteAction = new _shared_ui_objects_view_actions_api_call_action__WEBPACK_IMPORTED_MODULE_4__["ApiCallAction"]({
            object: this.object,
            icon: { name: 'delete' },
        ...
        switch (this.state) {
            case 'details':
                return [
                    {
                        tabName: 'Billing',
                        component: _tabs_configuration_details_billing_form_configuration_details_billing_form_component__WEBPACK_IMPORTED_MODULE_9__["ConfigurationDetailsBillingFormComponent"],
                    },
                ];
            case 'create':
                return [
                    {
                        tabName: 'Create',
                        component: _tabs_configuration_edit_form_configuration_edit_form_component__WEBPACK_IMPORTED_MODULE_8__["ConfigurationEditFormComponent"],
                    },
                ];
            case 'edit':
                return [
...
ConfigurationUiService.ctorParameters = () => [
    { type: undefined },
    { type: undefined },
    { type: String },
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] },
...
let ConfigurationsRoutingModule = class ConfigurationsRoutingModule {
};
...
let ConfigurationDetailsBillingFormComponent = class ConfigurationDetailsBillingFormComponent extends _shared_ui_objects_view_details_form_base__WEBPACK_IMPORTED_MODULE_2__["DetailsFormBase"] {
    constructor(formBuilder, configurationsApiService, router, config) {
        super();
        this.formBuilder = formBuilder;
        this.configurationsApiService = configurationsApiService;
        this.router = router;
        this.config = config;
        this.configurationBillingForm = this.formBuilder.group({
            // Billing
    ...
    saveConfiguration() {
        ...
        request.subscribe(() => {
            this.router.navigateByUrl(this.config.getPrevUrl('settings/configurations')).catch(() => {
            });
        }, (error) => {
...
ConfigurationDetailsBillingFormComponent.ctorParameters = () => [
...
let ConfigurationEditFormComponent = class ConfigurationEditFormComponent extends _shared_ui_objects_view_details_form_base__WEBPACK_IMPORTED_MODULE_3__["DetailsFormBase"] {
    constructor(formBuilder, configurationsApiService, router, config) {
        super();
        this.formBuilder = formBuilder;
        this.configurationsApiService = configurationsApiService;
    ...
    saveConfiguration() {
        const value = this.configurationForm.value;
...
ConfigurationEditFormComponent.ctorParameters = () => [
...
let ConfigurationBillingResolver = class ConfigurationBillingResolver {
    constructor(configurationApiService) {
        this.configurationApiService = configurationApiService;
    }
    resolve(route, state) {
        return this.configurationApiService.objectGetAction(route.params.id, 'billing').pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(configurationBilling => {
...
ConfigurationBillingResolver.ctorParameters = () => [
...
let ConfigurationListResolver = class ConfigurationListResolver {
    constructor(configurationApiService) {
        this.configurationApiService = configurationApiService;
    }
    resolve(route, state) {
        return this.configurationApiService.list(route.queryParams).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["catchError"])(() => Object(rxjs__WEBPACK_IMPORTED_MODULE_2__["of"])(null)));
    }
};
ConfigurationListResolver.ctorParameters = () => [
    { type: _configurations_api_service__WEBPACK_IMPORTED_MODULE_4__["ConfigurationsApiService"] }
];
...
let ConfigurationResolver = class ConfigurationResolver {
    ...
    resolve(route, state) {
        return this.configurationApiService.get(route.params.id).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["catchError"])(() => Object(rxjs__WEBPACK_IMPORTED_MODULE_2__["of"])(null)));
    }
};
ConfigurationResolver.ctorParameters = () => [
    { type: _configurations_api_service__WEBPACK_IMPORTED_MODULE_4__["ConfigurationsApiService"] }
];
...
let ConfigurationsApiService = class ConfigurationsApiService extends _fleio_api_service__WEBPACK_IMPORTED_MODULE_3__["FleioApiService"] {
    // noinspection JSUnusedGlobalSymbols
    constructor(httpClient, config) {
        super(config.getPanelApiUrl('configurations'));
        this.httpClient = httpClient;
        this.config = config;
    }
    specificConfiguration(id, type) {
        return this.objectGetAction(id, type);
    }
};
ConfigurationsApiService.ctorParameters = () => [
...
//# sourceMappingURL=configurations-configurations-module-es2015.js.map