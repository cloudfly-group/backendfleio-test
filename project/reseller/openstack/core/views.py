...
from fleio.openstack.api.identity import RoleDoesNotExist
...
from .serializers import ResellerCreateServiceSerializer
from .serializers import ResellerProjectSerializer

LOG = logging.getLogger(__name__)


class ResellerOpenstackClientsViewSet(ModelViewSet):
    ...
    def openstack_services(self, request, pk):
        ...
        serialized_projects = ResellerProjectSerializer(many=True).to_representation(projects)
    ...
    def create_openstack_service(self, request, pk):
        ...
        serializer = ResellerCreateServiceSerializer(data=request.data)
